...
gblines8 = lines!(ax1, kyrho, gb8a, color = :red, linestyle = :dash)
gblines9 = lines!(ax1, kyrho, gb9a, color = :orange, linestyle = :dash)
gblines10 = lines!(ax1, kyrho, gb10a, color = :brown, linestyle = :dash)
...
lines!(ax2, kyrho, ob8a, color = :red, linestyle = :dash) 
lines!(ax2, kyrho, ob9a, color = :orange, linestyle = :dash)
lines!(ax2, kyrho, ob10a, color = :brown, linestyle = :dash)
...
lines!(ax3, kyrho, gb8b, color = :red, linestyle = :dash)
lines!(ax3, kyrho, gb9b, color = :orange, linestyle = :dash)
lines!(ax3, kyrho, gb10b, color = :brown, linestyle = :dash)
...
lines!(ax4, kyrho, ob8b, color = :red, linestyle = :dash)
lines!(ax4, kyrho, ob9b, color = :orange, linestyle = :dash)
lines!(ax4, kyrho, ob10b, color = :brown, linestyle = :dash)
...
lines!(ax5, kyrho, gb8c, color = :red, linestyle = :dash)
lines!(ax5, kyrho, gb9c, color = :orange, linestyle = :dash)
lines!(ax5, kyrho, gb10c, color = :brown, linestyle = :dash)
...
lines!(ax6, kyrho, ob8c, color = :red, linestyle = :dash)
lines!(ax6, kyrho, ob9c, color = :orange, linestyle = :dash)
lines!(ax6, kyrho, ob10c, color = :brown, linestyle = :dash)
...
lines!(ax7, kyrho, gb8d, color = :red, linestyle = :dash)
lines!(ax7, kyrho, gb9d, color = :orange, linestyle = :dash)
lines!(ax7, kyrho, gb10d, color = :brown, linestyle = :dash)
...
lines!(ax8, kyrho, ob8d, color = :red, linestyle = :dash)
lines!(ax8, kyrho, ob9d, color = :orange, linestyle = :dash)
lines!(ax8, kyrho, ob10d, color = :brown, linestyle = :dash)
...
save("evalue_fine_kyscan_kyscan.png",fig)
