...
lines!(ax1, kyrho, gambet5, color = :cyan, label = "beta=0.004")
lines!(ax1, kyrho, gambet6, color = :purple, label = "beta=0.005")
...
lines!(ax2, kyrho, omgbet5, color = :cyan, label = "beta=0.005")
