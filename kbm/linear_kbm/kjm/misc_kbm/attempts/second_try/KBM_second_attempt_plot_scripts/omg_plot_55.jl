...
CairoMakie.lines!(kyrho, gambet4, color = :cyan, label = "beta=0.004")
CairoMakie.lines!(kyrho, gambet5, color = :blue, label = "beta=0.004")
CairoMakie.lines!(kyrho, gambet6, color = :purple, label = "beta=0.004")
