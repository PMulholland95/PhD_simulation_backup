...
CairoMakie.lines!(kyrho, gambet1, color = :blue, label = "beta=0.001")
CairoMakie.lines!(kyrho, gambet2, color = :green, label = "beta=0.002")
CairoMakie.lines!(kyrho, gambet3, color = :orange, label = "beta=0.003")
CairoMakie.lines!(kyrho, gambet4, color = :yellow, label = "beta=0.004")
CairoMakie.lines!(kyrho, gambet5, color = :purple, label = "beta=0.004")
CairoMakie.lines!(kyrho, gambet6, color = :cyan, label = "beta=0.004")
