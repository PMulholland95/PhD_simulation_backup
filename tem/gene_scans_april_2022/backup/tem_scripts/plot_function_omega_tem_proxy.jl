...
function plotOmegaTemProxy(scanlog::String, 
	...
	ax1 = Axis(fig[1,1], title = L"k_y \rho = 0.8", xlabel = L"a / L_n", ylabel = L"ω / (c_s/a)", xminorticksvisible = true, yminorticksvisible = true, xticksize = 40, yticksize = 40, xminorticksize = 20, yminorticksize = 20)
	ax2 = Axis(fig[1,2], title = L"k_y \rho = 1.0", xlabel = L"a / L_n", ylabel = L"ω / (c_s/a)", xminorticksvisible = true, yminorticksvisible = true, xticksize = 40, yticksize = 40, xminorticksize = 20, yminorticksize = 20)
	ax3 = Axis(fig[2,1], title = L"k_y \rho = 1.2", xlabel = L"a / L_n", ylabel = L"ω / (c_s/a)", xminorticksvisible = true, yminorticksvisible = true, xticksize = 40, yticksize = 40, xminorticksize = 20, yminorticksize = 20)
	ax4 = Axis(fig[2,2], title = L"k_y \rho = 1.4", xlabel = L"a / L_n", ylabel = L"ω / (c_s/a)", xminorticksvisible = true, yminorticksvisible = true, xticksize = 40, yticksize = 40, xminorticksize = 20, yminorticksize = 20)
